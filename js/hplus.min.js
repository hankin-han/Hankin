...
layer.config({
    ...
    $(function() {
        if ($("#fixednavbar").click(function() {
                ...
                localStorageSupport && localStorage.setItem("skin", "green"),
                    !1
            }), $(".s-skin-1").click(function() {
                return $("body").removeClass("skin-2"),
                    $("body").removeClass("skin-3"),
                    $("body").addClass("skin-1"),
                localStorageSupport && localStorage.setItem("skin", "blue"),
                    !1
            }), $(".s-skin-3").click(function() {
                return $("body").removeClass("skin-1"),
                    $("body").removeClass("skin-2"),
                    $("body").addClass("skin-3"),
                localStorageSupport && localStorage.setItem("skin", "yellow"),
                    !1
            }), localStorageSupport) {
            var s = localStorage.getItem("skin"),
                e = localStorage.getItem("collapse_menu"),
            ...
            "blue" == s && $("body").addClass("skin-1"),
            "yellow" == s && $("body").addClass("skin-3")
        }
